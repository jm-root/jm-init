...
module.exports = function (service, opts = {}) {
  ...
  acl.init = async function () {
    let path = '../' + defaultDir
    let permissions = require(path + '/permissions')
    let resources = require(path + '/resources')
    let roles = require(path + '/roles')
    let doc = await this.post('/init', {
